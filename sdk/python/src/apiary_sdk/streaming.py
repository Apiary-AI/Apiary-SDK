...
Usage inside a :class:`~apiary_sdk.service_worker.ServiceWorker`::
...
class StreamingTask:
    ...
    Args:
        client: Authenticated :class:`~apiary_sdk.client.ApiaryClient`.
    ...
    def send_chunk(
        ...
        *,
        ...
        Raises:
            ...
            :class:`~apiary_sdk.exceptions.ApiaryError`: On API errors.
        """
        if self._finalized:
